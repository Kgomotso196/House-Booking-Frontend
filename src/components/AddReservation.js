...
const AddReservation = () => {
  ...
  return (
    <div>
      ...
      <label>
         Checking Date: <input type="text" name='checking_date' value={formData.checking_date} onChange={handleChange} />
        </label>
        <label>
        Checkingout Date: <input type="text" name='checkout_date' value={formData.checkout_date} onChange={handleChange} />
        </label>
        <label>
        City: <input type="text" name='city' value={formData.city} onChange={handleChange} />
        </label>
        <label>
        House Price: <input type="text" name='house_price' value={formData.house_price} onChange={handleChange} />
        </label>
